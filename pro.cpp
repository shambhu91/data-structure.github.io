// C++ code to find friends nearby the given location
#include <bits/stdc++.h>
...
//Handling Files
ifstream friend_list ("friends.json");
ofstream out ("getFriends.json");
...
struct json
{
	...
	*/
	...
	void json_parser()
	{					 
		if (friend_list.is_open())
		{
			
			while (getline(friend_list, line))
			{
		...
		// closing stream of Friends's file.
		friend_list.close();
